...
public class GameLogic : MonoBehaviour
{
    ...
    public GameObject failAudioHolder, alarmAudioHolder, windAudioHolder;
    ...
    public void DestoryStartUI()
    {
        Transform t = startUI.GetComponent<Transform>();
    ...
    {
        windAudioHolder.GetComponent<AudioSource>().Stop();
        alarmAudioHolder.GetComponent<AudioSource>().Play();
    }
    ...
    void DisplayPattern()
    {
        ...
        if (currentDisplayIndex < puzzleOrder.Length)
        {
            ...
            Debug.Log("AudioSource::" + puzzleSpheres[puzzleOrder[currentDisplayIndex]].GetComponent<AudioSource>());
          //  puzzleSpheres[puzzleOrder[currentDisplayIndex]].GetComponent<AudioSource>().Play();
    ...
    public void PuzzleSuccess()
    {
        ...
        alarmAudioHolder.GetComponent<AudioSource>().Stop();
        windAudioHolder.GetComponent<AudioSource>().Play();
    }
